...
EXPERIMENT_NAME = "Proyeccion_Calidad_Aire_Risaralda"
...
pipelines = {
    "RandomForest": Pipeline([("preprocess", preprocess), ("model", RandomForestRegressor(random_state=13, n_jobs=-1))]),
    ...
    "SVR-rbf":      Pipeline([("preprocess", preprocess), ("model", SVR(kernel="rbf"))]),
}
if HAS_XGB:
